...
~~~ bash
curl -X "POST" "https://api.cruxconnect.com/api/products/skus/" \
...
~~~ bash
http --json POST 'https://api.cruxconnect.com/api/products/skus/' \
...
def send_request():
    # Create SKU - Supplier
    # POST https://api.cruxconnect.com/api/products/skus/
