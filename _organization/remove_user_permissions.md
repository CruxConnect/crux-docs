...
~~~ bash
curl -X "DELETE" "https://stable.projectthanos.com/organizations/users/permissions/5de38a8e-800e-4cba-84c5-ee6c27f304d8/" \
...
~~~ bash
http --json DELETE 'https://stable.projectthanos.com/organizations/users/permissions/5de38a8e-800e-4cba-84c5-ee6c27f304d8/' \
...
def send_request():
    ...
    # DELETE https://stable.projectthanos.com/organizations/users/permissions/5de38a8e-800e-4cba-84c5-ee6c27f304d8/

    try:
        response = requests.delete(
            url="https://stable.projectthanos.com/organizations/users/permissions/5de38a8e-800e-4cba-84c5-ee6c27f304d8/",
            headers={
                "Authorization": "Token a0f17278bed479ee719ea890b8caf0329e1f3e5b",
                "Content-Type": "application/json; charset=utf-8",
            },
