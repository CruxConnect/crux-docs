...
~~~ bash
curl -X "POST" "https:/.cruxconnect.com/accounting/transactions/export/" \
...
~~~ bash
http --json POST 'https:/.cruxconnect.com/accounting/transactions/export/' \
...
def send_request():
    ...
    # POST https:/.cruxconnect.com/accounting/transactions/export/

    try:
        response = requests.post(
            url="https:/.cruxconnect.com/accounting/transactions/export/",
            headers={
                "Authorization": "Token f97322af7ca5a5dacc73a6eae3e90dc975391fda",
                "Content-Type": "application/json; charset=utf-8",
            },
